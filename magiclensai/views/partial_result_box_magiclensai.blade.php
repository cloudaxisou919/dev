                ...
                <div class="col-6 mb-2 mt-2 ">
                    <div class="image-result group">
                        <div class="relative aspect-square rounded-lg mb-2 overflow-hidden group-hover:shadow-lg transition-all">
                                <img src="{{$entry->image_path}}"  class="w-full h-full aspect-square object-cover object-center img-fluid" alt="{{$entry->input}}">
                                <div class="flex items-center justify-center gap-2 w-full h-full absolute top-0 left-0 opacity-0 transition-opacity group-hover:!opacity-100">
                                    <div class="flex flex-col">
                                        <div>
                                            <a href="{{$entry->image_path}}" class="btn items-center justify-center w-9 h-9 p-0 download" download="download_<?php echo $entry->id ?>">
                                            ...
                                            <a data-fslightbox="gallery" href="{{$entry->image_path}}"  target="_blank" class="btn lb items-center justify-center w-9 h-9 p-0">
